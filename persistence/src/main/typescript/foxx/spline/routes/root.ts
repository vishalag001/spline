...
router
    .get('/execution-events/:eventKey/lineage-overview/:maxDepth',
...
router
    .post('/execution-plans',
        (req: Foxx.Request, res: Foxx.Response) => {
            const plan = req.body
            // todo: ???
            // res.send("<PLAN> Hello: " + JSON.stringify(plan));
            // todo: ???
        })
    .body(joi.object().required())
    .summary('Add a new execution plan')
    .description('Add a new execution plan');
...
router
    .post('/execution-events',
        (req: Foxx.Request, res: Foxx.Response) => {
            ...
            // todo: ???
            // res.send("<EVENT> Hello: " + JSON.stringify(event));
            // todo: ???
        })
    .body(joi.object().required())
    .summary('Add a new execution event')
    .description('Add a new execution event');
